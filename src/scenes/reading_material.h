...
enum ReadingMaterialEnum {
    ...
    /* -- */ START_EXTRA_READING_MATERIAL,

    /* 20 */ READING_MATERIAL_CREDITS = START_EXTRA_READING_MATERIAL,

    /* -- */ END_EXTRA_READING_MATERIAL,

    /* -- */ TOTAL_READING_MATERIAL = END_EXTRA_READING_MATERIAL,
    /* -- */ TOTAL_EXTRA_READING_MATERIAL = END_EXTRA_READING_MATERIAL - START_EXTRA_READING_MATERIAL
};
